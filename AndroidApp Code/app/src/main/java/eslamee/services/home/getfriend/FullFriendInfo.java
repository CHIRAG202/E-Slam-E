...
import eslamee.models.MainResponseModel;
...
public class FullFriendInfo  extends AppCompatActivity implements View.OnClickListener, Callback<MainResponseModel> {
    ...
    BasicInfoModel personalInfoModel;
   ...
   /* public void showdetail() {
    ...
    void showPersonInfo() {
        ...
        String strDate = dateFormat.format(personalInfoModel.getDob());

        Picasso picasso = Picasso.with(this);
        picasso.load(personalInfoModel.getPic())
                .centerInside()
                .fit()
                .into(finimage);
        picasso.load(personalInfoModel.getPic())
        ...
        personal_info.put("Name",personalInfoModel.getName());
        personal_info.put("Father's Name",personalInfoModel.getFathers_name());
        personal_info.put("Mother's Name",personalInfoModel.getMothers_name());
        personal_info.put("DOB",strDate);
        personal_info.put("Email Id",personalInfoModel.getMail_id());
        personal_info.put("Describe",personalInfoModel.getDescribe_urslf());
        personal_info.put("Motto",personalInfoModel.getMotto());
        personal_info.put("Aim In Life",personalInfoModel.getAim_in_life());
        personal_info.put("Hobbies",personalInfoModel.getHobbies());
        personal_info.put("Sun Sign",personalInfoModel.getSun_sign());
