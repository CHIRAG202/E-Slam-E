package eslamee.common.base_activities;
...
import eslamee.R;
import eslamee.services.home.usersign_services.EslamELoginActivity;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.share_app:
                ...
                intent2.putExtra(Intent.EXTRA_TEXT,
                        String.format(getString(R.string.promo_msg_template),
                                ("https://drive.google.com/open?id=1_ykjVOcSvoRne0ycubcQ74kkuA-2Hvx8")));
            ...
            case R.id.log_out:
                ...
                Intent intent1 = new Intent(this, EslamELoginActivity.class);
